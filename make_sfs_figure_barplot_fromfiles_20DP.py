...
def main():
    ...
    # specify input files
    biennis_4f = '../dadi/biennis_4f_20DP_equalproj.txt'
    biennis_0f = '../dadi/biennis_0f_20DP_equalproj.txt'
    biennis_all = '../dadi/biennis_allsites_20DP_equalproj.txt'
    elata_4f = '../dadi/elata_4f_20DP_equalproj.txt'
    elata_0f = '../dadi/elata_0f_20DP_equalproj.txt'
    elata_all = '../dadi/elata_allsites_20DP_equalproj.txt'
