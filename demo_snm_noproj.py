...
dd = dadi.Misc.make_data_dict_vcf("../vcfs/variants.32samples.0.5missing.biallelicSNPs.nomissing.vcf.gz", "../../popmap_nogrand.txt")
dd4f = dadi.Misc.make_data_dict_vcf("../vcfs/variants.32samples.0.5missing.biallelicSNPs.nomissing.4folddegen.recode.vcf.gz", "../../popmap_nogrand.txt")
dd0f = dadi.Misc.make_data_dict_vcf("../vcfs/variants.32samples.0.5missing.biallelicSNPs.nomssing.0folddegen.recode.vcf.gz", "../../popmap_nogrand.txt")

fs_biennis = dadi.Spectrum.from_data_dict(dd, ['biennis'], projections = [32], polarized = False)
fs4f_biennis = dadi.Spectrum.from_data_dict(dd4f, ['biennis'], projections = [32], polarized = False)
fs0f_biennis = dadi.Spectrum.from_data_dict(dd0f, ['biennis'], projections = [32], polarized = False)
fs_elata = dadi.Spectrum.from_data_dict(dd, ['elata'], projections = [32], polarized = False)
fs4f_elata = dadi.Spectrum.from_data_dict(dd4f, ['elata'], projections = [32], polarized = False)
fs0f_elata = dadi.Spectrum.from_data_dict(dd0f, ['elata'], projections = [32], polarized = False)
