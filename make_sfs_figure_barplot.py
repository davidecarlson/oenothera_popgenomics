...
def main():
    ...
    elata_all_sfs = bootstrap(ddall, 5000000, [16], 100, ['elata'])
    biennis_all_sfs = bootstrap(ddall, 5000000, [16], 100, ['biennis'])
    ...
    # make dataframes
    elata_4f_df = make_df(elata_4f_prop, "elata", "4fold", "../dadi/elata_4f_equalproj.txt")
    elata_0f_df = make_df(elata_0f_prop, "elata", "0fold", "../dadi/elata_0f_equalproj.txt")
    biennis_4f_df = make_df(biennis_4f_prop, "biennis", "4fold", "../dadi/biennis_4f_equalproj.txt")
    biennis_0f_df = make_df(biennis_0f_prop, "biennis", "0fold", "../dadi/biennis_0f_equalproj.txt")
    elata_all_df = make_df(elata_all_prop, "elata", "Allsites", "../dadi/elata_allsites_equalproj.txt")
    biennis_all_df = make_df(biennis_all_prop, "biennis", "Allsites", "../dadi/biennis_allsites_equalproj.txt")

    # plot the spectra
    plot_sfs([biennis_4f_df,biennis_0f_df,elata_4f_df, elata_0f_df],['r', 'b',],"../figures/sfs_barplot_coding_unequalproj")
    plot_sfs([biennis_all_df,elata_all_df],['r', 'b',],"../figures/sfs_barplot_allsites_unequalproj")
