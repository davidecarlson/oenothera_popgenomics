...
def main():
    ...
    zerofold_vcf = '../vcfs/variants.30samples.0.5missing.recombined.minDP20.sitetype.0folddegen.recode.vcf.gz'
    fourfold_vcf = '../vcfs/variants.30samples.0.5missing.recombined.minDP20.sitetype.4folddegen.recode.vcf.gz'
    allsites_vcf = '../vcfs/variants.30samples.0.5missing.recombined.minDP20.vcf.gz'
    ...
    elata_4f_sfs = bootstrap(dd4f, 5000000, [18], 100, ['elata'])
    elata_0f_sfs = bootstrap(dd0f, 5000000, [18], 100, ['elata'])
    biennis_4f_sfs = bootstrap(dd4f, 5000000, [18], 100, ['biennis'])
    biennis_0f_sfs = bootstrap(dd0f, 5000000, [18], 100, ['biennis'])
    elata_all_sfs = bootstrap(ddall, 5000000, [18], 100, ['elata'])
    ...
    # make dataframes
    elata_4f_df = make_df(elata_4f_prop, "elata", "4fold", "../dadi/elata_4f_20DP_equalproj.txt")
    elata_0f_df = make_df(elata_0f_prop, "elata", "0fold", "../dadi/elata_0f_20DP_equalproj.txt")
    biennis_4f_df = make_df(biennis_4f_prop, "biennis", "4fold", "../dadi/biennis_4f_20DP_equalproj.txt")
    biennis_0f_df = make_df(biennis_0f_prop, "biennis", "0fold", "../dadi/biennis_0f_20DP_equalproj.txt")
    elata_all_df = make_df(elata_all_prop, "elata", "Allsites", "../dadi/elata_allsites_20DP_equalproj.txt")
    biennis_all_df = make_df(biennis_all_prop, "biennis", "Allsites", "../dadi/biennis_allsites_20DP_equalproj.txt")

    # plot the spectra
    plot_sfs([biennis_4f_df,biennis_0f_df,elata_4f_df, elata_0f_df],['r', 'b',],"../figures/sfs_barplot_coding_20DP_unequalproj")
    plot_sfs([biennis_all_df,elata_all_df],['r', 'b',],"../figures/sfs_barplot_allsites_20DP_unequalproj")
    plot_sfs([biennis_4f_df,biennis_0f_df,elata_4f_df, elata_0f_df],['r', 'b',],"../figures/sfs_barplot_coding_20DP_equalproj")
    plot_sfs([biennis_all_df,elata_all_df],['r', 'b',],"../figures/sfs_barplot_allsites_20DP_equalproj")
